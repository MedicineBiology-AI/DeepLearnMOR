...
def main(_):
    ...
    graph, bottlenecks, resized_image, bottlenecks_size = pretrain_model.load_inception_v3(
        FLAGS.model_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_graph",
        type=str,
        default="../inception_v3/retrained_graph.pb",
        help="Output directory to save the trained graph."
    )
    parser.add_argument(
        "--output_checkpoint_dir",
        type=str,
        default="../inception_v3/checkpoint",
        help="Output directory to save the trained graph."
    )
    parser.add_argument(
        "--output_labels",
        type=str,
        default="../inception_v3/output_labels.txt",
        help="Directory to save the output labels."
    )
    parser.add_argument(
        "--summaries_dir",
        type=str,
        default="../inception_v3/retrain_logs",
        help="Path to save summary logs for TensorBoard."
    )
    parser.add_argument(
        "--bottlenecks_dir",
        type=str,
        default="../inception_v3/bottlenecks",
